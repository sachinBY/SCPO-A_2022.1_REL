...
---
(payload map {
	udcs:((skuPerishableParamEntity map (value, index) -> {
	...
	MINSHELFLIFEDUR: $."perishableParameters.minimumShelfLifeDuration.value",
	MINSHIPSHELFLIFEDUR: $."perishableParameters.minimumShipmentShelfLifeDuration.value",
	SHELFLIFEDUR: $."perishableParameters.shelfLifeDuration.value",
